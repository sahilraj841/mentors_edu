    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        ...
        <div className="bg-gray-50 p-6 rounded-md shadow-sm">
          ...
          <p className="text-sm">
            MENTORS EDUSERV is one of the top institutes of BIHAR for JEE-MAIN & ADVANCED, NEET, AIIMS, NTSE, KVPY & Olympiads and
        ...
        <div className="bg-gray-50 p-6 rounded-md shadow-sm">
          ...
          <p className="text-sm">
            ...
            contributing to our country through excellence in Pre-Engineering & Pre-Medical Entrance Examinations.
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-md shadow-sm">
          ...
          <p className="text-sm">
            The foundation of MENTORS was laid with the establishment  in 2012. It was
        ...
        <div className="bg-gray-50 p-6 rounded-md shadow-sm">
          ...
          <p className="text-sm">
            Mentors Eduserv intends to fill the supply side gap in the education sector by providing a platform to budding
      ...
      <div className="mb-16">
        ...
        <p className="text-center max-w-5xl mx-auto mb-10">
          Education Consultant will promote Mentor's courses among their local area within student network. The
          ...
          exams through Mentor's classroom, Digital, and Distance Learning Programs.
        </p>
      </div>
      ...
      <div className="fixed bottom-6 right-6">
        <a href="https://wa.me/8676000041" target="_blank" rel="noopener noreferrer" className="block">
